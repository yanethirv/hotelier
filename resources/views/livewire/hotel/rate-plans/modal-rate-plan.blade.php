        ...
        <x-modal-component :showModal="$showModal" :action="$action">
            <div class="pb-6">
                ...
                <div class="mt-3 sm:mt-0 sm:text-left">
                    ...
                    <div class="mt-2">
                        <div>
                            <x-input-component label="Rate Plan" name="name" placeholder="Enter rate plan" type="text" />
                        </div>
                        <div>
                        ...
                        <div>
                            <x-input-component label="Suggestion" name="suggestion" placeholder="Enter suggestion" type="text" />
                        </div>
                        <div>
