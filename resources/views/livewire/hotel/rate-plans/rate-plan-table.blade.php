        ...
        <div class="w-full overflow-hidden rounded-lg shadow-xs mt-4">
                ...
                <table class="w-full whitespace-normal">
                    <thead>
                        <tr
                            ...
                            <th wire:click="sortBy('name')" class="px-6 py-3 cursor-pointer">Rate Plan
                                @include('layouts._sort-icon',['field' => 'name'])</th>
                            <th class="px-4 py-3">Hotel</th>
                            <th class="px-6 py-3 cursor-pointer">Suggestion</th>
                            <th class="px-6 py-3 cursor-pointer">Description</th>
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    <a wire:click="showModal({{$ratePlan->id}})" href="javascript:void(0)"
                                    ...
                                    <a wire:click="deleteConfirm({{$ratePlan->id}})" href="javascript:void(0)"
            ...
            <div
                ...
                <span class="flex items-center col-span-3">
                    Showing {{ $ratePlans->firstItem() }} to {{ $ratePlans->lastItem() }} out of {{ $ratePlans->total() }}
                </span>
