        ...
        <div class="w-full overflow-hidden rounded-lg shadow-xs mt-4">
                ...
                <table class="w-full whitespace-normal">
                    <thead>
                        <tr
                            ...
                            <th wire:click="sortBy('name')" class="px-6 py-3 cursor-pointer">Name
                                @include('layouts._sort-icon',['field' => 'name'])</th>
                            <th class="px-4 py-3">Hotel</th>
                            <th wire:click="sortBy('rate')" class="px-6 py-3 cursor-pointer">Rate
                                @include('layouts._sort-icon',['field' => 'rate'])</th>
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    <a wire:click="showModal({{$mealPlan->id}})" href="javascript:void(0)"
                                    ...
                                    <a wire:click="deleteConfirm({{$mealPlan->id}})" href="javascript:void(0)"
            ...
            <div
                ...
                <span class="flex items-center col-span-3">
                    Showing {{ $mealPlans->firstItem() }} to {{ $mealPlans->lastItem() }} out of {{ $mealPlans->total() }}
                </span>
            ...
            window.addEventListener('swal:confirm', event => {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.livewire.emit('deleteMealPlan', event.detail.id);
                        Toast.fire({
                        icon: 'success',
                        title: 'Meal Plan has been deleted.',
                        })
                    }
                });
