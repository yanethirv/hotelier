        ...
        <div class="w-full overflow-hidden rounded-lg shadow-xs mt-4">
                ...
                <table class="w-full whitespace-normal">
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3 text-sm">
                                {{$restaurant->restaurantTheme->name}}
                            </td>
                            <td class="px-4 py-3 text-sm">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    <a wire:click="showModal({{$restaurant->id}})" href="javascript:void(0)"
                                    ...
                                    <a wire:click="deleteConfirm({{$restaurant->id}})" href="javascript:void(0)"
            ...
            <div
                ...
                <span class="flex items-center col-span-3">
                    Showing {{ $restaurants->firstItem() }} to {{ $restaurants->lastItem() }} out of {{ $restaurants->total() }}
                </span>
            ...
            window.addEventListener('swal:confirm', event => {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.livewire.emit('deleteRestaurant', event.detail.id);
                        Toast.fire({
                        icon: 'success',
