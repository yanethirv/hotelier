        ...
        <div class="w-full overflow-hidden rounded-lg shadow-xs mt-4">
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    <a wire:click="showModal({{$policyType->id}})" href="javascript:void(0)"
                                    ...
                                    <a wire:click="deleteConfirm({{$policyType->id}})" href="javascript:void(0)"
            ...
            <div
                ...
                <span class="flex items-center col-span-3">
                    Showing {{ $policyTypes->firstItem() }} to {{ $policyTypes->lastItem() }} out of {{ $policyTypes->total() }}
                </span>
            ...
            window.addEventListener('swal:confirm', event => {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.livewire.emit('deletePolicyType', event.detail.id);
                        Toast.fire({
                        icon: 'success',
                        title: 'Policy Type has been deleted.',
                        })
                    }
                });
