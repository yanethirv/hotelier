        ...
        <div class="w-full overflow-hidden rounded-lg shadow-xs mt-4">
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    <a wire:click="showModal({{$occupancy->id}})" href="javascript:void(0)"
                                    ...
                                    <a wire:click="deleteConfirm({{$occupancy->id}})" href="javascript:void(0)"
            ...
            <div
                ...
                <span class="flex items-center col-span-3">
                    Showing {{ $occupancies->firstItem() }} to {{ $occupancies->lastItem() }} out of {{ $occupancies->total() }}
                </span>
            ...
            window.addEventListener('swal:confirm', event => {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.livewire.emit('deleteOccupancy', event.detail.id);
                        Toast.fire({
                        icon: 'success',
                        title: 'Occupancy has been deleted.',
                        })
                    }
                });
