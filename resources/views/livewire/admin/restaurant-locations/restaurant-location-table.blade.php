        ...
        <div class="w-full overflow-hidden rounded-lg shadow-xs mt-4">
                ...
                <table class="w-full whitespace-normal">
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3 text-sm">
                                {{$restaurantLocation->description}}
                            </td>
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    <a wire:click="showModal({{$restaurantLocation->id}})" href="javascript:void(0)"
                                    ...
                                    <a wire:click="deleteConfirm({{$restaurantLocation->id}})" href="javascript:void(0)"
            ...
            <div
                ...
                <span class="flex items-center col-span-3">
                    Showing {{ $restaurantLocations->firstItem() }} to {{ $restaurantLocations->lastItem() }} out of {{ $restaurantLocations->total() }}
                </span>
                <span class="col-span-2"></span>
                <!-- Pagination -->
                <span class="flex col-span-4 mt-2 sm:mt-auto sm:justify-end">
                    {{ $restaurantLocations->links() }}
                </span>
            </div>
        </div>
    </div>
            ...
            window.addEventListener('swal:confirm', event => {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.livewire.emit('deleteRestaurantLocation', event.detail.id);
                        Toast.fire({
                        icon: 'success',
                        title: 'Restaurant Location has been deleted.',
                        })
                    }
                });
