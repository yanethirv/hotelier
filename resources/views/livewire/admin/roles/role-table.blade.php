                    ...
                    <thead>
                        <tr
                            ...
                            <th wire:click="sortBy('name')"  class="px-4 py-3">Name
                                @include('layouts._sort-icon',['field' => 'name'])</th>
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    <a wire:click="$emit('toggleModal', {{$rol->id}}, 'Role')" href="javascript:void(0)"
                                    ...
                                    <a wire:click="$emit('addPermission', {{$rol->id}})" href="javascript:void(0)" class="text-xs mr-2 rounded-l-none hover:scale-110 focus:outline-none flex justify-center px-4 py-2 rounded font-semibold cursor-pointer 
                                        hover:bg-blue-600 hover:text-blue-100 bg-blue-100 text-blue-600 border duration-200 ease-in-out border-none transition">
                                        <div class="flex leading-5">Permissions</div>
                                    </a>
                                    @if(!$rol->count_user && canView('role delete'))
                                    <a wire:click="deleteConfirm({{$rol->id}})" href="javascript:void(0)"
