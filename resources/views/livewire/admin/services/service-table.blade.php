                ...
                <table class="w-full whitespace-normal">
                    <thead>
                        <tr
                            ...
                            <th wire:click="sortBy('price')" class="px-4 py-3">Price
                                @include('layouts._sort-icon',['field' => 'price'])</th>
                            <th wire:click="sortBy('cost')" class="px-4 py-3">Cost
                                @include('layouts._sort-icon',['field' => 'cost'])</th>
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    <a wire:click="showModal({{$service->id}})" href="javascript:void(0)"
                                    ...
                                    <a wire:click="deleteConfirm({{$service->id}})" href="javascript:void(0)"
            ...
            window.addEventListener('swal:confirm', event => {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.livewire.emit('deleteService', event.detail.id);
                        Toast.fire({
                        icon: 'success',
