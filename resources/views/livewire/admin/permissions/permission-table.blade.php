    ...
    <div class="flex-1">
        <div class="bg-gray-50 dark:border-gray-700 dark:text-gray-400 dark:bg-gray-800 py-3 items-center justify-between">
            ...
            <div class="flex text-gray-500 pt-4">
                <button wire:click="$emit('toggleModalPermission')" type="button"
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    <a wire:click="$emit('toggleModalPermission', {{$permission->id}}, 'Permission')" href="javascript:void(0)"
                                    ...
                                    <a wire:click="deleteConfirm({{$permission->id}})" href="javascript:void(0)"
