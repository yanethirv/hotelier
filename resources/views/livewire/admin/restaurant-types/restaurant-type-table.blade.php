        ...
        <div class="w-full overflow-hidden rounded-lg shadow-xs mt-4">
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    <a wire:click="showModal({{$restaurantType->id}})" href="javascript:void(0)"
                                    ...
                                    <a wire:click="deleteConfirm({{$restaurantType->id}})" href="javascript:void(0)"
            ...
            <div
                ...
                <span class="flex items-center col-span-3">
                    Showing {{ $restaurantTypes->firstItem() }} to {{ $restaurantTypes->lastItem() }} out of {{ $restaurantTypes->total() }}
                </span>
            ...
            window.addEventListener('swal:confirm', event => {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.livewire.emit('deleteRestaurantType', event.detail.id);
                        Toast.fire({
                        icon: 'success',
                        title: 'Restaurant Type has been deleted.',
                        })
                    }
                });
