    ...
    <div class="flex-1">
        <div class="bg-white dark:border-gray-700 dark:text-gray-400 dark:bg-gray-800 px-4 py-3 items-center justify-between border-t border-gray-200 sm:px-6">
            <div class="flex text-gray-500">
                ...
                <input wire:model.debounce.300ms="search" type="text" class="form-input w-full text-gray-500 ml-2" placeholder="Search Rate Plan..." />
        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-blue-50">
                <tr>
                    ...
                    <th wire:click="sortBy('suggestion')" 
                        scope="col" class="cursor-pointer px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                        SUGGESTION
                        @include('layouts._sort-icon',['field' => 'suggestion'])
                    </th>
                    <th wire:click="sortBy('description')" 
                        scope="col" class="cursor-pointer px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                        DESCRIPTION
                        @include('layouts._sort-icon',['field' => 'description'])
                    </th>
