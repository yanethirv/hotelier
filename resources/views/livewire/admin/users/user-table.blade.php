                ...
                <table class="w-full whitespace-normal">
                    <thead>
                        <tr
                            ...
                            <th wire:click="sortBy('email')"  class="px-4 py-3">Email
                                @include('layouts._sort-icon',['field' => 'email'])</th>
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3 text-sm">
                                <div class="text-sm text-gray-900 w-10 h-10">
                                    <img class="rounded-full" src="{{ asset('storage/'.$user->avatar) }}" alt="{{$user->name}}">
                                </div>
                            </td>
                            <td class="px-4 py-3 text-sm">
                                {{$user->name}}
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    <a wire:click="showModal({{$user->id}})" href="javascript:void(0)"
                                    ...
                                    <a wire:click="deleteConfirm({{$user->id}})" href="javascript:void(0)"
