        ...
        <div class="w-full overflow-hidden rounded-lg shadow-xs mt-4">
                ...
                <table class="w-full whitespace-normal">
                    <thead>
                        <tr
                            ...
                            <th wire:click="sortBy('nickname')"  class="px-4 py-3">Name
                                @include('layouts._sort-icon',['field' => 'nickname'])</th>
                            <th wire:click="sortBy('product')" class="px-4 py-3">Product
                                @include('layouts._sort-icon',['field' => 'product'])</th>
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    <a wire:click="showModal({{$plan->id}})" href="javascript:void(0)"
                                    ...
                                    <a wire:click="deleteConfirm({{$plan->id}})" href="javascript:void(0)"
            ...
            <div
                ...
                <span class="flex items-center col-span-3">
                    Showing {{ $plans->firstItem() }} to {{ $plans->lastItem() }} out of {{ $plans->total() }}
                </span>
            ...
            window.addEventListener('swal:confirm', event => {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.livewire.emit('deletePlan', event.detail.id);
                        Toast.fire({
                        icon: 'success',
