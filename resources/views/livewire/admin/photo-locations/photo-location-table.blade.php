        ...
        <div class="w-full overflow-hidden rounded-lg shadow-xs mt-4">
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    <a wire:click="showModal({{$photoLocation->id}})" href="javascript:void(0)"
                                    ...
                                    <a wire:click="deleteConfirm({{$photoLocation->id}})" href="javascript:void(0)"
            ...
            <div
                ...
                <span class="flex items-center col-span-3">
                    Showing {{ $photoLocations->firstItem() }} to {{ $photoLocations->lastItem() }} out of {{ $photoLocations->total() }}
                </span>
                <span class="col-span-2"></span>
                <!-- Pagination -->
                <span class="flex col-span-4 mt-2 sm:mt-auto sm:justify-end">
                    {{ $photoLocations->links() }}
                </span>
            </div>
        </div>
    </div>
            ...
            window.addEventListener('swal:confirm', event => {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.livewire.emit('deletePhotoLocation', event.detail.id);
                        Toast.fire({
                        icon: 'success',
                        title: 'Photo Location has been deleted.',
                        })
                    }
                });
