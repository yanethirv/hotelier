        ...
        <div class="w-full overflow-hidden rounded-lg shadow-xs mt-4">
                ...
                <table class="w-full whitespace-normal">
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3 text-sm">
                                <div class="flex m-2">
                                    <a href="{{ asset('storage/'.$resource->attachment) }}" target="_blank" rel="noopener noreferrer" class="text-xs mr-2 rounded-l-none hover:scale-110 focus:outline-none flex justify-center px-4 py-2 rounded font-semibold cursor-pointer 
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    <a wire:click="showModal({{$resource->id}})" href="javascript:void(0)"
                                    ...
                                    <a wire:click="deleteConfirm({{$resource->id}})" href="javascript:void(0)"
            ...
            <div
                ...
                <span class="flex items-center col-span-3">
                    Showing {{ $resources->firstItem() }} to {{ $resources->lastItem() }} out of {{ $resources->total() }}
                </span>
            ...
            window.addEventListener('swal:confirm', event => {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.livewire.emit('deleteResource', event.detail.id);
                        Toast.fire({
                        icon: 'success',
