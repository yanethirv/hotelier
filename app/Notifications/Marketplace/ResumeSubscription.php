...
class ResumeSubscription extends Notification
{
    use Queueable;
    ...
    {
        return [
            'content' => 'You have resumed your subscription: '.$this->subscriptionTransaction->marketplaceSubscription->subscription_name,
