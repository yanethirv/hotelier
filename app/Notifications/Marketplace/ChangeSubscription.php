...
class ChangeSubscription extends Notification
{
    use Queueable;
    ...
    {
        return [
            'content' => 'You have changed your subscription to: '.$this->subscriptionTransaction->marketplaceSubscription->subscription_name,
