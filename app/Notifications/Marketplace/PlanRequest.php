...
class PlanRequest extends Notification
{
    use Queueable;
    ...
    {
        return [
            'content' => 'The user '.$this->planTransaction->user->name. ' has requested activation of the plan '.$this->planTransaction->plan->nickname,
