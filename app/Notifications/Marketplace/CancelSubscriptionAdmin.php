...
class CancelSubscriptionAdmin extends Notification
{
    use Queueable;
    ...
    {
        return [
            'content' => 'The user '.$this->subscriptionTransaction->user->name. ' has cancelled the subscription '.$this->subscriptionTransaction->marketplaceSubscription->subscription_name,
