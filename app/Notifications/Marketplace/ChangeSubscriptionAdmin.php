...
class ChangeSubscriptionAdmin extends Notification
{
    use Queueable;
    ...
    {
        return [
            'content' => 'The user '.$this->subscriptionTransaction->user->name. ' has changed to subscription '.$this->subscriptionTransaction->marketplaceSubscription->subscription_name,
