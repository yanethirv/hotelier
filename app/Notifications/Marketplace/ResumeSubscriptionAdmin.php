...
class ResumeSubscriptionAdmin extends Notification
{
    use Queueable;
    ...
    {
        return [
            'content' => 'The user '.$this->subscriptionTransaction->user->name.' has resumed the subscription '.$this->subscriptionTransaction->marketplaceSubscription->subscription_name,
