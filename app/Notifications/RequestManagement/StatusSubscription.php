...
class StatusSubscription extends Notification
{
    use Queueable;
    ...
    {
        return [
            'content' => 'Your subscription request '.$this->subscriptionsTransaction->marketplaceSubscription->subscription_name. ' has been changed to status '.$this->subscriptionsTransaction->requestStatus->name,
