...
class StatusPlan extends Notification
{
    use Queueable;
    ...
    {
        return [
            'content' => 'Your plan request '.$this->plansTransaction->plan->nickname. ' has been changed to status '.$this->plansTransaction->requestStatus->name,
