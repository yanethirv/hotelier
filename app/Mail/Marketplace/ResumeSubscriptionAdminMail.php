...
class ResumeSubscriptionAdminMail extends Mailable
{
    ...
    {
        return $this->subject('Client has resumed a subscription')->markdown('emails.marketplace.resume-subscription-admin');
    }
}
