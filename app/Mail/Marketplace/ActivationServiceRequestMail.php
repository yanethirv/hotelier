...
class ActivationServiceRequestMail extends Mailable
{
    ...
    {
        return $this->subject('Service Activation Request')->markdown('emails.marketplace.activation-service-request');
    }
}
