...
class CancelSubscriptionAdminMail extends Mailable
{
    ...
    {
        return $this->subject('Client Cancel Subscription')->markdown('emails.marketplace.cancel-subscription-admin');
    }
}
