...
class SubscriptionRequestAdminMail extends Mailable
{
    ...
    {
        return $this->subject('New Subscription Request')->markdown('emails.marketplace.subscription-request-admin');
    }
}
